...
La gran mayoría de proyectos que hago los guardo en un sitio llamado [Github](https://github.com/) (yeha, los links también funcionan). Algunos proyectos los hago públicos, y otros los guardo de manera privada. Github sirve para muchas cosas: 
...
En cuanto a mí, personalmente tengo 3 cuentas de Github activas (solo una en uso actualmente), que reflejan distintas épocas de la historia de Loredana programadora: la primera fue [lorara11](https://github.com/lorara11), la siguiente [sanduio](https://github.com/sanduio), y ahora tengo una nueva, [loredanasandu](https://github.com/loredanasandu), que planea sustituir a las otras (pero moveré los mejores proyectos antiguos a esta nueva cuenta). En específico, aquí está el código de esta web: [github.com/loredanasandu/loredanasandu.com](https://github.com/loredanasandu/loredanasandu.com)
...
Y también hay muchíiisimas otras plataformas para hacer un montón de otras cosas (por ejemplo, esta web se ejecuta en un servidor de [Vercel](https://vercel.com/), que ejecuta el código a través de... adivina... Github, cómo no)
